...
def test_add_book_invalid_isbn_too_long():
    ...
    success, message = add_book_to_catalog("Test Book", "Test Author", "1234567890123456789", 5)
...
def test_add_book_title_too_long():
    ...
    success, message = add_book_to_catalog("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi"
